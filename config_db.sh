...
sudo chmod 666 /opt/oracle/product/23ai/dbhomeFree/network/admin/tnsnames.ora

sudo cp /opt/oracle/product/23ai/dbhomeFree/lib/libclntsh.so /opt/oracle/product/23ai/dbhomeFree/instantclient/
